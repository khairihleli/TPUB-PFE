...
public class SecurityConfig {
    ...
    /** Routes reachable without a token (an invalid token is ignored there). */
    static final String[] PUBLIC_ENDPOINTS = {
            "/api/auth/**",
            "/api/diffusion/next",
            "/api/diffusion/interactions",
            // Device routes stay permitAll here: DeviceKeyInterceptor authenticates them (X-ZELQANE-Device-Key).
