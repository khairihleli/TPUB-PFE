...
public final class SupervisionProperties {
    ...
    /** {@code zelqane.supervision.*}: heartbeat, presence, saturation and SSE transport. */
    @Data
    @ConfigurationProperties(prefix = "zelqane.supervision")
    ...
    /** {@code zelqane.approval.*}: multi-level approval policy ({@code 1} disables a double approval). */
    @Data
    ...
    /** {@code zelqane.notifications.*}: retention and optional e-mail delivery. */
    @Data
