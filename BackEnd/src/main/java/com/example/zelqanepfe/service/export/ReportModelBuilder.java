...
public class ReportModelBuilder {
    ...
    private ReportModel dashboard(DashboardResponse d, LocalDate today, Instant now) {
        ...
        return new ReportModel("Tableau de bord ZELQANE", "Indicateurs de la plateforme", periodLabel(today, today), now,
    ...
    private ReportModel mine(StatisticsMineResponse mine, Instant now) {
        ...
        return new ReportModel("Mes statistiques ZELQANE", "Diffusions de vos campagnes",
