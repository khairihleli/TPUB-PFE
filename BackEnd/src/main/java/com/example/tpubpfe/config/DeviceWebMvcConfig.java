...
import com.example.tpubpfe.security.device.DeviceKeyInterceptor;
import com.example.tpubpfe.security.device.DeviceRateLimiter;
...
public class DeviceWebMvcConfig implements WebMvcConfigurer {
    ...
    public DeviceWebMvcConfig(DeviceKeyService deviceKeyService, TpubProperties properties, Clock clock) {
    ...
    public DeviceRateLimiter deviceRateLimiter() {
        TpubProperties.Device device = properties.getDevice();
