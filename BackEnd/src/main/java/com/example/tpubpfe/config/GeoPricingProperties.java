...
import com.example.tpubpfe.service.pricing.PricingCalculator;
...
public final class GeoPricingProperties {
    ...
    /** {@code tpub.geo}: polygon validation limits and heatmap range. */
    @Data
    @ConfigurationProperties(prefix = "tpub.geo")
    ...
    /** {@code tpub.pricing.dynamic}: multipliers of the dynamic pricing (§4.6). */
    @Data
    @ConfigurationProperties(prefix = "tpub.pricing.dynamic")
    public static class Dynamic implements InitializingBean {

        /** Also read from {@code TPUB_DYNAMIC_PRICING_ENABLED} by {@link GeoPricingConfig}. */
        ...
        public void afterPropertiesSet() {
            ...
            if (minMultiplier == null || maxMultiplier == null || minMultiplier.signum() <= 0
                ...
                throw new IllegalStateException(
                        "tpub.pricing.dynamic: min-multiplier doit être > 0 et ≤ max-multiplier.");
            }
        }
    }
}
