...
/**
 * AI analysis configuration (docs/round2-contract.md §2.1), prefix {@code tpub.analysis}.
 * <p>
 * Defaults are read from the documented environment variables ({@code TPUB_OCR_MODE}, {@code TPUB_AI_PROVIDER},
 * {@code OPENAI_API_KEY}…) so that {@code application.yml} needs no entry; explicit properties still win.
 * The legacy {@code tpub.ai.openai-enabled} and {@code tpub.ai.ocr.*} keys are ignored.
 */
@Data
@ConfigurationProperties(prefix = "tpub.analysis")
public class AiAnalysisProperties {
    ...
    public static class Ocr {
        ...
        private String mode = env("TPUB_OCR_MODE", "auto");
        private String tessdataPath = env("TPUB_OCR_TESSDATA", "./tessdata");
        private String languages = env("TPUB_OCR_LANGUAGES", "fra+eng+ara");
    ...
    public static class Provider {
        ...
        private String type = env("TPUB_AI_PROVIDER", "local");
        private long timeoutMs = envLong("TPUB_AI_PROVIDER_TIMEOUT_MS", 90_000L);
    ...
    public static class Learning {
        private boolean enabled = envBoolean("TPUB_AI_LEARNING_ENABLED", true);
        private boolean autoApply = envBoolean("TPUB_AI_LEARNING_AUTO_APPLY", true);
