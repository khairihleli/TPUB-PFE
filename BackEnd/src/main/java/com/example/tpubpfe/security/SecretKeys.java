...
public final class SecretKeys {
    ...
    public static final String MEDIA_LABEL = "tpub-media-signing-v1";
    public static final String TOTP_LABEL = "tpub-totp-v1";
    ...
    public static byte[] mediaSigningKey(TpubProperties properties) {
        return key(properties.getMedia().getSigningSecret(), properties.getJwt().getSecret(), MEDIA_LABEL);
    }

    public static byte[] totpKey(TpubProperties properties) {
