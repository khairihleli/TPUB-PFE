...
import com.example.tpubpfe.dto.TwoFactorStatusResponse;
import com.example.tpubpfe.model.RecoveryCode;
import com.example.tpubpfe.model.SessionRevokeReason;
import com.example.tpubpfe.model.User;
import com.example.tpubpfe.repository.RecoveryCodeRepository;
...
import com.example.tpubpfe.security.totp.RecoveryCodes;
import com.example.tpubpfe.security.totp.TotpCipher;
...
public class TwoFactorService {
    ...
    public TwoFactorService(UserRepository userRepository, RecoveryCodeRepository recoveryCodeRepository,
                            ...
                            TotpPolicy policy, TpubProperties properties, Clock clock) {
     ...
     */
    @Transactional(noRollbackFor = com.example.tpubpfe.exception.ApiException.class)
