package com.example.tpubpfe.service.notification;
 ...
 * {@link JavaMailSender} exists (SMTP configured) and {@code tpub.notifications.mail.from} is set; nothing is ever
...
public class NotificationMailer {
    ...
    private final ExecutorService executor = Executors.newSingleThreadExecutor(runnable -> {
        Thread thread = new Thread(runnable, "tpub-notification-mail");
    ...
    public void send(NotificationPushEvent event) {
        ...
        try {
            ...
            mail.setSubject("[TPUB] " + notification.getTitle());
