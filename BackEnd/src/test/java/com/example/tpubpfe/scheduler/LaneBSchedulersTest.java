...
class LaneBSchedulersTest {
    ...
    void expiryAppliesPeriodAndTtlRules() {
        ...
        ReservationExpiryScheduler scheduler = new ReservationExpiryScheduler(repository, sync, new TpubProperties(), CLOCK);
    ...
    void expiryDoesNothingWithoutCandidates() {
        ...
        new ReservationExpiryScheduler(repository, sync, new TpubProperties(), CLOCK).runOnce();
