...
class ReportRenderersTest {
    ...
    private static ReportModel model(int dayCount) {
        ...
        return new ReportModel("Statistiques de diffusion", "Réseau ZELQANE", "Du 01/09/2026 au 30/09/2026", GENERATED,
    ...
    void pdfCarriesTheHeaderTheKpisAndEveryTable() throws Exception {
        ...
        assertThat(text).contains("ZELQANE").contains("Statistiques de diffusion")
                .contains("Du 01/09/2026 au 30/09/2026").contains("Généré le 16/09/2026 14:30")
                .contains("Par jour").contains("Par campagne").contains("Estimations internes ZELQANE");
        reader.close();
    }
