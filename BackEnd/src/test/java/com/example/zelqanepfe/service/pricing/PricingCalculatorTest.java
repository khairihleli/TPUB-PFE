...
class PricingCalculatorTest {
    ...
    void environmentAliasEnablesOrDisablesThePricing() {
        ...
        new com.example.zelqanepfe.config.GeoPricingConfig(dynamic, new MockEnvironment()
                .withProperty("ZELQANE_DYNAMIC_PRICING_ENABLED", "false"));
        assertThat(dynamic.isEnabled()).isFalse();
        GeoPricingProperties.Dynamic explicit = new GeoPricingProperties.Dynamic();
        new com.example.zelqanepfe.config.GeoPricingConfig(explicit, new MockEnvironment()
                .withProperty("ZELQANE_DYNAMIC_PRICING_ENABLED", "false")
                .withProperty("zelqane.pricing.dynamic.enabled", "true"));
