...
class AiVerificationServiceTest {
    ...
    void calibratedAnalysisFeedbackAndRecalibration() throws Exception {
        ...
        User advertiser = userRepository.save(User.builder().email("ia-" + suffix + "@zelqane.test").passwordHash("x")
        ...
        User admin = userRepository.save(User.builder().email("ia-admin-" + suffix + "@zelqane.test").passwordHash("x")
