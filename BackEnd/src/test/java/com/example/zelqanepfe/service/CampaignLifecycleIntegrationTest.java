...
class CampaignLifecycleIntegrationTest {
    ...
    void fullLifecycleWithOverride() {
        ...
        User advertiser = userRepository.save(User.builder().email("annonceur-" + suffix + "@zelqane.test")
        ...
        User admin = userRepository.save(User.builder().email("admin-" + suffix + "@zelqane.test")
