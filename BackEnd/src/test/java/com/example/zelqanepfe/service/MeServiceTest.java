...
class MeServiceTest {
    ...
    void setUp() {
        ...
        user = User.builder().id(9L).email("ann@zelqane.test").nom("Ann").passwordHash(encoder.encode("Ancien123"))
        ...
        UserDetailsImpl principal = new UserDetailsImpl(9L, "ann@zelqane.test", "x", "Ann", "ANNONCEUR", true, "current-sid");
