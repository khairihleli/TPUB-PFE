...
import com.example.zelqanepfe.model.LoginHistory;
...
import com.example.zelqanepfe.repository.LoginHistoryRepository;
...
class AccountsSecurityWebTest {
    ...
    private static String unique(String prefix) {
        return prefix + "-" + UUID.randomUUID().toString().substring(0, 8) + "@zelqane.test";
    }
    ...
    void protectedRoutesAnswerJson401And403() throws Exception {
        ...
        String expired = jwtService.generateToken("nobody@zelqane.test", "ANNONCEUR", "sid",
    ...
    void errorHandlerUsesStableCodes() throws Exception {
        UserDetailsImpl admin = new UserDetailsImpl(900L, "admin-err@zelqane.test", "x", "Admin", "ADMINISTRATEUR", true);
