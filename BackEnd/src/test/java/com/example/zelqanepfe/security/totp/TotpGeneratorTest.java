...
class TotpGeneratorTest {
    ...
    void otpauthUriEncodesTheAccount() {
        assertThat(TotpGenerator.otpauthUri("ZELQANE", "ops+1@zelqane.com", "ABCDEF"))
                .isEqualTo("otpauth://totp/ZELQANE:ops%2B1%40zelqane.com?secret=ABCDEF&issuer=ZELQANE&algorithm=SHA1&digits=6&period=30");
    }
