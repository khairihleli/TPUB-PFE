...
export const APROPOS_HERO = {
  ...
  primary: { label: "Parler à TPUB", href: "/contact" },
  // Points to the TPUB page on the group site (the CTA band links to the group home).
  secondary: { label: "TPUB dans le groupe" },
} as const;
...
export const MISSION_SECTION = {
  ...
  statement:
    "TPUB est conçu pour que chaque annonceur choisisse où et quand il diffuse, et reçoive la trace de ce qui a été réellement diffusé.",
  // The principle itself is the quote beside this text: do not repeat it here.
  text: "L'affichage a toujours eu de la portée, rarement de la preuve. TPUB part d'un principe simple, qui déplace la charge de la preuve de l'acheteur vers l'opérateur.",
  quote: "L'audience se mesure, elle ne se déclare pas.",
  quoteSource: "Principe fondateur de TPUB",
...
export const GROUP_SECTION = {
  ...
  text: "Au sein du groupe, TPUB appartient au pôle Médias, audience & données, avec AFRIVA et INFINTRA. La présence physique crée l'attention, TPUB la transforme en portée traçable, AFRIVA vise à en faire une communauté récurrente, et INFINTRA structure les données économiques utiles à la décision.",
  identity: "TPUB contracte avec ses clients sous sa propre identité.",
  chainLabel: "De la présence physique à la décision",
  tpubLink: "Voir TPUB sur le site du groupe",
...
export const GROUP_CHAIN = [
  ...
  { key: "tpub", name: "TPUB", role: "Transforme l'attention en portée traçable", self: true },
...
export const STATUS_SECTION_APROPOS = {
  ...
  notice:
    "TPUB est au stade de la conception. Les fonctionnalités et typologies présentées sur ce site décrivent l'intention de conception de la plateforme.",
  nowTitle: "Dès maintenant",
  now: [
    "Créer un compte annonceur",
    "Préparer des campagnes en brouillon",
    "Demander un plan média à l'équipe TPUB",
  ],
...
export const TUNISIE_SECTION = {
  ...
  text: "Les budgets de campagne s'expriment en dinars dans la plateforme, et l'équipe TPUB vous répond depuis Tunis.",
  imageAlt:
    "Écran d'affichage numérique au bord d'une route côtière tunisienne au coucher du soleil",
} as const;

export const APROPOS_CTA = {
  title: "Une question sur TPUB ?",
  highlight: "Parlons-en.",
  lede: "Objectifs, zones, calendrier ou simple curiosité : l'équipe TPUB vous répond.",
  primary: { label: "Parler à TPUB", href: "/contact" },
} as const;
