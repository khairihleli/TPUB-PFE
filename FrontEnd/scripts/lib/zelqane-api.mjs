/**
 * Shared helpers for the Node scripts that talk to a running ZELQANE backend directly
 * (seed-demo.mjs, demo-scenario.mjs). No dependency beyond Node ≥ 22 (fetch, FormData, Blob, zlib).
 */
import { deflateSync } from "node:zlib";

export const API = (process.env.ZELQANE_API_URL ?? "http://localhost:8080").replace(/\/$/, "");
